...
},{"./$":22,"./$.def":7,"./$.has":13,"./$.hide":14,"./$.iter-buggy":17,"./$.iter-create":18,"./$.iterators":21,"./$.library":24,"./$.redef":26,"./$.tag":29,"./$.wks":33}],20:[function(_dereq_,module,exports){
"use strict";
...
module.exports = function (name) {
  return store[name] || (store[name] = Symbol && Symbol[name] || (Symbol || _dereq_('./$.uid'))('Symbol.' + name));
};
...
},{"./$":22,"./$.an-object":4,"./$.def":7,"./$.enum-keys":9,"./$.get-names":11,"./$.global":12,"./$.has":13,"./$.keyof":23,"./$.library":24,"./$.property-desc":25,"./$.redef":26,"./$.shared":27,"./$.support-desc":28,"./$.tag":29,"./$.to-iobject":30,"./$.uid":31,"./$.wks":33}],37:[function(_dereq_,module,exports){
'use strict';
...
},{"./ShareUtils":38,"core-js/fn/array/iterator":1,"core-js/fn/math/trunc":2,"core-js/fn/symbol":3}],38:[function(_dereq_,module,exports){
/**
 * ShareUtils
 * @class
